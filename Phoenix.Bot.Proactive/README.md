...
- In a terminal, navigate to `Phoenix.Bot.Proactive`

    ```bash
    # change into project folder
    cd Phoenix.Bot.Proactive
    ```
...
- Run the bot from a terminal or from Visual Studio, choose option A or B.
  ...
  - Navigate to `Phoenix.Bot.Proactive` folder
  - Select `Phoenix.Bot.Proactive.csproj` file
